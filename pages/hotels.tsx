...
const hotels: Hotel[] = [
  ...
  },
  {
    ...
    rooms: ['Residential Suite', 'Standard Room'],
    services: ['Rooms & Apartment', 'Laundry Services', 'Food & Restaurant', 'Parking', '24 Hours Room Service', 'Power Backup'],
  },
  {
    ...
    rooms: ['Deluxe Double', 'Deluxe Family Room', 'Deluxe Twin'],
    services: ['Rooms & Apartment', 'Laundry Services', 'Food & Restaurant', 'Parking', '24 Hours Room Service', 'Power Backup'],
  },
  {
    name: 'Hyderabad',
  ...
  },
  {
    ...
    rooms: ['Deluxe', 'Deluxe Quad', 'Deluxe Triple', 'King Suite', 'Residential Suite'],
    services: ['Rooms & Apartment', 'Laundry Services', 'Food & Restaurant', 'Parking', '24 Hours Room Service', 'Power Backup'],
  },
];
